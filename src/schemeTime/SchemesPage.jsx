...
import SuccessRateChart from "../schemePage/SuccessRateChart";
import Location from "../schemePage/Location";
              ...
              <table className="w-full text-sm text-left rtl:text-right text-gray-500 bg-[#f2f7fb] border-2 border-[#f2f7fb]-900">
                ...
                <tbody>
                  ...
                  <tr className="bg-[#f2f7fb] border-b border-gray-400 hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">Welfare scheme beneficiaries</td>
                    <td className="px-6 py-4">
                  ...
                  <tr className="bg-[#f2f7fb] border-b border-gray-400 hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">Farmers, agricultural workers</td>
                    <td className="px-6 py-4">
                  ...
                  <tr className="bg-[#f2f7fb] border-b border-gray-400 hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      Offer short-term credit by pledging Recurring Deposit (RD)
                      or Time Deposit (TD)
                    </td>
                    <td className="px-6 py-4">Yes</td>
                  </tr>
